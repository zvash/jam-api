...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-image-link', __webpack_require__(3));
  Vue.component('detail-image-link', __webpack_require__(6));
  Vue.component('form-image-link', __webpack_require__(9));
  Vue.component('icon-external-image-link', __webpack_require__(13));
});
      ...
      ? _c(
          ...
          [
            _vm.field.icon
              ...
              : _c("span", [
                  _vm._v(
                    _vm._s(_vm.field.text ? _vm.field.text : _vm.field.value)
                  )
                ])
          ]
        )
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    _c("div", { staticClass: "w-1/5 py-4" }, [
      _c("h4", { staticClass: "px-8 font-normal text-80" }, [
        _vm._v("\n      " + _vm._s(_vm.field.name) + "\n    ")
      ])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "px-8 py-4 w-4/5" }, [
      _vm.field.value
        ? _c("p", { staticClass: "text-90" }, [
            _c(
              "a",
...
Component.options.__file = "resources/js/components/Icons/ExternalLink.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9aa437f6", Component.options)
  } else {
    hotAPI.rerender("data-v-9aa437f6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9aa437f6", module.exports)
  }
}
