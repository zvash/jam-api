...
namespace Milanjam\KeyTwoValues;

use Laravel\Nova\Fields\Field;
use Laravel\Nova\Http\Requests\NovaRequest;

class KeyTwoValues extends Field
{
    /**
     ...
     * @var string
     */
    public $component = 'key-two-values';
    ...
    /**
     * The label that should be used for the value2 table heading.
     *
     * @param  string  $label
     * @return $this
     */
    public function value2Label($label)
    {
    ...
    public function jsonSerialize()
    {
        return array_merge(parent::jsonSerialize(), [
            ...
            'value2Label' => $this->value2Label ?? __('Value2'),
